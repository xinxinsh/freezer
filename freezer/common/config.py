...
_COMMON = [
    ...
    cfg.StrOpt('backend-id',
               dest='backend_id',
               default=DEFAULT_PARAMS['backend_id'],
               help="Id of backend backup"),
    cfg.StrOpt('source-id',
               dest='source_id',
               default=DEFAULT_PARAMS['source_id'],
               help="Id of source backup"),
